...
private:
	...
	std::unordered_map<unsigned int, int> widthCache;
	std::unordered_map<unsigned int, FT_BBox> bboxCache;
	std::unordered_map<std::string, PDFUsedFont::TextMeasures> textCache;

	//std::unordered_map<std::string, UIntList> glyphCache;
	//std::unordered_map<std::string, GlyphUnicodeMappingList> glyphUnicodeMappingListCache;
};
